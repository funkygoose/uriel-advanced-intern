              ...
              <div className="statistics__content--header">
                <div
                  className={`statistics__heading ${
                    greenText === 0 && `statistics__heading--active`
                  }`}
                >
                ...
                <div
                  className={`statistics__heading ${
                    greenText === 1 && `statistics__heading--active`
                  }`}
                >
                ...
                <div
                  className={`statistics__heading ${
                    greenText === 2 && `statistics__heading--active`
                  }`}
                >
                  Improve your health
                </div>
                <div
                  className={`statistics__heading ${
                    greenText === 3 && `statistics__heading--active`
                  }`}
                >
                ...
                <div
                  className={`statistics__heading ${
                    greenText === 4 && `statistics__heading--active`
                  }`}
                >
                  Increase happiness
                </div>
                <div
                  className={`statistics__heading ${
                    greenText === 5 && `statistics__heading--active`
                  }`}
                >
